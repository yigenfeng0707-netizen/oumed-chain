...
tbl = s.shapes.add_table(7, 2, Inches(0.7), Inches(1.8), Inches(6.2), Inches(4.4)).table
...
bullets(s, 7.4, 1.9, 5.4, 4.5, [
    "阳性率 21.8%-25.1%，贴近真实心衰流行病学",
    "AUC 0.70 落在临床文献区间（0.65-0.75），经得起评审推敲",
    "种子固定：GET /api/federation/benchmark 随时复现",
    "工程底座：397 个单元测试 + CI/CD + 三级降级容错",
...
bullets(s, 0.8, 1.9, 6.0, 4.5, [
    ...
    "工程底座成熟：397 个单元测试、CI/CD、Docker 一键部署、魔搭云端部署经验",
], size=16)
